...
public static class JvmBytecodeParser
{
	...
	private static readonly Dictionary<JvmOpcode, JavaAttributeInfoBaker> Bakery = new()
	{
		...
		[JvmOpcode.aload] = JvmLocalVarRefInstruction.Read,
		[JvmOpcode.anewarray] = JvmClassReferenceInstruction.Read,
		...
		[JvmOpcode.astore] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.checkcast] = JvmClassReferenceInstruction.Read,
		...
		[JvmOpcode.dload] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.dstore] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.fstore] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.goto_s] = JvmBranchInstruction.Read,
		[JvmOpcode.goto_w] = JvmBranchInstruction.ReadWide,
		...
		[JvmOpcode.iinc] = JvmLocalVarRefConstInstruction.Read,
		...
		[JvmOpcode.iload] = JvmLocalVarRefInstruction.Read,
		[JvmOpcode.impdep1] = DefaultBakery,
		[JvmOpcode.impdep2] = DefaultBakery,
		[JvmOpcode.imul] = DefaultBakery,
		[JvmOpcode.ineg] = DefaultBakery,
		[JvmOpcode.instanceof] = JvmClassReferenceInstruction.Read,
		[JvmOpcode.invokedynamic] = JvmClassNameAndTypeReferenceCountInstruction.Read,
		...
		[JvmOpcode.istore] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.lload] = JvmLocalVarRefInstruction.Read,
		[JvmOpcode.lmul] = DefaultBakery,
		[JvmOpcode.lneg] = DefaultBakery,
		[JvmOpcode.lookupswitch] = JvmLookupSwitchInstruction.Read,
		...
		[JvmOpcode.lstore] = JvmLocalVarRefInstruction.Read,
		...
		[JvmOpcode.multianewarray] = JvmClassReferenceConstInstruction.Read,
		[JvmOpcode.new_obj] = JvmClassReferenceInstruction.Read,
		[JvmOpcode.newarray] = JvmPrimitiveReferenceInstruction.Read,
		...
		[JvmOpcode.sipush] = JvmSipushInstruction.Read,
		[JvmOpcode.swap] = DefaultBakery,
		[JvmOpcode.tableswitch] = JvmTableSwitchInstruction.Read,
		[JvmOpcode.wide] = JvmWideInstruction.Read,
	};
